...
in function `get_binary_imagev3())`.  I am using the S and L channel of HLS
and a combination of the Sobel Operator in x and y direction, Magnitude of the Gradient
